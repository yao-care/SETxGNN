...
BASE_URL = "https://setxgnn.yao.care"
...
def generate_capability_statement() -> dict:
    ...
    return {
        ...
        "id": "setxgnn-fhir-server",
        "url": f"{BASE_URL}/fhir/metadata",
        "version": "1.0.0",
        "name": "SETxGNNFHIRServer",
        "title": "SETxGNN FHIR Server - Sweden Drug Repurposing",
        "description": "FHIR R4 server for Sweden TxGNN drug repurposing predictions",
        "status": "active",
