...
import pandas as pd
from setxgnn.collectors import DrugBundleAggregator
from setxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from setxgnn.collectors.drug_bundle import PredictedIndication
    from setxgnn.collectors.known_relations import KnownRelationsChecker
...
def patch_single_drug(
    ...
    """
    from setxgnn.collectors.drug_bundle import DrugBundle
